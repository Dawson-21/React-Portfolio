...
export default function IconBox({ icon, title, desc }: Props) {
  return (
    <>
      <div className="w-[14%] xl:w-[18%] lg:w-[15%] md:w-[18%] sm:w-[11%] py-[1.4vw] ml-[43%] xl:ml-[41%] lg:ml-[43%] md:ml-[41%] sm:ml-[45%] rounded-xl bg-gradient-135 from-bright-orange from-20% to-regal-blue to-80%">
