...
export default function Portfolio() {
  return (
    <>
      <div className="relative isolate px-6 lg:py-0 pt-32 py-10 lg:pt-14 lg:px-8 bg-gray-100 dark:bg-gray-950 shadow-lg shadow-bright-orange/45 dark:shadow-gray-900 overflow-clip rounded-b-xl">
        <div
        ...
        <div className="grid max-w-screen-2xl px-8 py-8 mx-auto lg:py-20 lg:grid-cols-12">
          <div className="lg:col-span-12">
            <h1 className="max-w-2xl mb-4 mx-auto lg:text-center font-extrabold tracking-tight leading-none text-4xl sm:text-5xl lg:text-6xl dark:text-white">
              Portfolio
            </h1>
            <p className="max-w-2xl mb-6 mx-auto font-light text-justify text-gray-700 lg:mb-8 text-lg dark:text-gray-300">
      ...
      <div className="py-20 bg-gray-100">
        ...
        <div className="inline-flex xl:mx-[12%] lg:mx-[8%] md:mx-[5%] mx-[4%] lg:gap-10 md:gap-6 sm:gap-4 gap-2 pt-6">
          ...
          <div className="hidden lg:block max-w-[33%] rounded-xl shadow-xl dark:shadow-none bg-white dark:bg-gray-950 dark:border-gray-950">
            <Card
              img="DCTC2.png"
