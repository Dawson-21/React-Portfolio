    ...
    <>
      <div className="grid grid-cols-12 py-20 bg-light dark:bg-dark2 snap-start">
        ...
        <div className="md:col-span-4 col-span-6 md:pl-0 sm:pl-5 text-dark dark:text-white">
          ...
          <ul className="font-myFont text-left 2xl:pl-[13.3vw] xl:pl-[37%] lg:pl-[35%] md:pl-[31%] pl-[32%] pt-4 lg:-mr-0 md:-mr-8 font-light xl:text-lg lg:text-base">
            <li>HTML5/CSS3</li>
            <li>TypeScript</li>
            <li>React.js</li>
            <li>Tailwind CSS</li>
        ...
        <div className="md:col-span-4 col-span-6 lg:pr-[15%] md:pr-[5%] md:pl-0 sm:pl-5 text-dark dark:text-white">
          ...
          <ul className="font-myFont text-left 2xl:pl-[7.5vw] xl:pl-[28%] lg:pl-[23%] md:pl-[20%] sm:pl-[23%] pl-[26%] pt-4 font-light xl:text-lg lg:text-base">
            <li>UI/UX Design</li>
