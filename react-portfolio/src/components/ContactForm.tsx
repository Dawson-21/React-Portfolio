      ...
      <div className="2xl:px-[11vw] xl:px-[9vw] lg:px-[7vw] md:px-[15vw] sm:px-[10vw] px-[5vw] py-10 bg-transparent font-myFont">
        <form onSubmit={handleOnSubmit}>
          <div className="lg:w-1/2 w-full inline-block lg:pr-10 -translate-y-[25px]">
            <label htmlFor="name" className="block text-lg font-medium text-dark dark:text-white">Name</label>
            <input
          ...
          <div className="lg:w-1/2 w-full lg:inline-block">
            <label htmlFor="message" className="block text-lg font-medium text-dark dark:text-white">Message</label>
            <textarea
              id="message"
              name="message"
              rows={5}
